            ...
            <div className='space-y-8'>
              ...
              <div className='flex flex-col items-center gap-4'>
                ...
                <div className='text-muted-foreground flex items-center gap-4 text-sm'>
                  ...
                  <span>{t('cta.downloadsCount')}</span>
                  <Separator orientation='vertical' className='!h-4' />
                  <span>{t('cta.ratingCount')}</span>
                </div>
              </div>
              ...
              <div className='space-y-6'>
                <h1 className='text-4xl font-bold tracking-tight text-balance sm:text-5xl lg:text-6xl'>
                  <Trans
                    ...
                    ns='landing'
                    components={{
                      1: <span className='relative mx-2 inline-block' />,
                      2: <span className='bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent' />,
                      3: <span className='absolute start-0 -bottom-2 h-1 w-full bg-gradient-to-r from-primary/30 to-secondary/30' />,
                    }}
                  />
                </h1>
